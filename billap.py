...
class Bill_App:
    def __init__(self):
        ...
        lbl_color = 'black'
        # Title of App
        Label(self.root, text="Billing System - TECH HUB SHOP", bd=12, relief=GROOVE, fg="Black", bg=bg_color, font=("times new roman", 25, "bold"), pady=3).pack(fill=X)

        # ==========Customer Frame==========#
        F1 = LabelFrame(text="Customer Details", font=("times new roman", 12, "bold"), fg="Black", bg=bg_color, relief=GROOVE, bd=10)
        F1.place(x=0, y=80, relwidth=1)

        # ===============Customer Name===========#
        Label(F1, text="Customer Name", bg=bg_color, fg="Black", font=("times new roman", 15, "bold")).grid(row=0, column=0, padx=10, pady=5)
        cname_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.cus_name)
        cname_en.grid(row=0, column=1, ipady=4, ipadx=30, pady=5)

        # =================Customer Phone==============#
        Label(F1, text="Phone No", bg=bg_color, fg="Black", font=("times new roman", 15, "bold")).grid(row=0, column=2, padx=20)
        cphone_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.c_phone)
        cphone_en.grid(row=0, column=3, ipady=4, ipadx=30, pady=5)

        # ====================Customer Bill No==================#
        Label(F1, text="Bill No.", bg=bg_color, fg="Black", font=("times new roman", 15, "bold")).grid(row=0, column=4, padx=20)
        cbill_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.c_bill_no)
        cbill_en.grid(row=0, column=5, ipadx=30, ipady=4, pady=5)

        # ==================Face Frame=====================#
        F2 = LabelFrame(self.root, text='FACE', bd=10, relief=GROOVE, bg=bg_color, fg="BLACK", font=("times new roman", 13, "bold"))
        ...
        # ===================Total FACE Prices=============#
        self.total_face_prices = ((self.codeF001.get() * 180000) +
        ...
        # ====================Total BODY Prices============#
        self.total_body_prices = ((self.codeB001.get() * 235000) +
        ...
        # ====================Total Other Prices==========#
        self.total_other_prices = ((self.codeM001.get() * 320000) +
