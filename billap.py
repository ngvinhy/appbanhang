...
class Bill_App:
    def __init__(self):
        ...
        lbl_color = '#F6F5EC'
        # Title of App
        Label(self.root, text="Billing System - TECH HUB SHOP", bd=12, relief=GROOVE, fg=lbl_color, bg=bg_color, font=("times new roman", 25, "bold"), pady=3).pack(fill=X)

        # ==========Customers Frame==========#
        F1 = LabelFrame(text="Customer Details", font=("times new roman", 12, "bold"), fg=lbl_color, bg=bg_color,
                        relief=GROOVE, bd=10)
        F1.place(x=0, y=80, relwidth=1)

        # ===============Customer Name===========#
        Label(F1, text="Customer Name", bg=bg_color, fg=lbl_color, font=("times new roman", 15, "bold")).grid(
            row=0, column=0, padx=10, pady=5)
        cname_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.cus_name)
        cname_en.grid(row=0, column=1, ipady=4, ipadx=30, pady=5)

        # =================Customer Phone==============#
        Label(F1, text="Phone No", bg=bg_color, fg=lbl_color, font=("times new roman", 15, "bold")).grid(
            row=0, column=2, padx=20)
        cphon_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.c_phone)
        cphon_en.grid(row=0, column=3, ipady=4, ipadx=30, pady=5)

        # ====================Customer Bill No==================#
        cbill_lbl = Label(F1, text="Bill No.", bg=bg_color, fg=lbl_color, font=("times new roman", 15, "bold"))
        ...
        # ==================Face Frame=====================#
        F2 = LabelFrame(self.root, text='FACE', bd=10, relief=GROOVE, bg=bg_color, fg=lbl_color,
        ...
        # ===================================#
        F2 = LabelFrame(self.root, text='BODY', bd=10, relief=GROOVE, bg=bg_color, fg=lbl_color,
                        font=("times new roman", 13, "bold"))
        ...
        F2 = LabelFrame(self.root, text='OTHERS', bd=10, relief=GROOVE, bg=bg_color, fg=lbl_color,
                        font=("times new roman", 13, "bold"))
        ...
        # ===========Buttons Frame=============#
        F4 = LabelFrame(self.root, text='Bill Menu', bd=10, relief=GROOVE, bg=bg_color, fg=lbl_color,
                        font=("times new roman", 13, "bold"))
